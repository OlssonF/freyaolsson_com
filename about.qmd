...
|  |  |
|:---------------------------:|-------------------------------------------|
| ![](images/pluralakes.png){fig-align="left" width="159" height="64"} | Within the [PLURALAKES project](https://www.stockholmresilience.org/research/research-projects/pluralakes.html) I am working with the process-based ecosystem model PCLake+ and optimisation algorithms to identify pathways to desired lake futures using a target-seeking approach for scenario development. |
